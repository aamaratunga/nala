...
struct LocalTerminalView: NSViewRepresentable {
    ...
    func makeNSView(context: Context) -> CoralTerminalView {
        ...
        // GitHub dark theme
        tv.nativeBackgroundColor = CoralTheme.terminalNSBackground
        tv.nativeForegroundColor = CoralTheme.terminalNSForeground
        tv.caretColor = CoralTheme.terminalNSCaret
        tv.installColors(CoralTheme.ansiPalette)
