...
final class PulseParser: @unchecked Sendable {
    private let logger = os.Logger(subsystem: "com.coral.app", category: "PulseParser")
    ...
    private let watcherQueue = DispatchQueue(label: "com.coral.pulseparser", qos: .utility)
